<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StaffHome.aspx.cs" Inherits="StatePharmaceuticalCooperations.Staff.StaffHome" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Staff Home | SPC</title>
...
<h1>State Pharmaceutical Cooperation (SPC)</h1>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link" aria-current="page" href="StockUpdate.aspx">Stock Update</a>
        </li>
        <li class="nav-item">
